...
{
    /// <summary>
    /// Noms de messages standards à transmettre via MessageBroker
    /// (suffisamment génériques pour être potentiellement utiles dans n'importe quel type d'application)
    /// </summary>
